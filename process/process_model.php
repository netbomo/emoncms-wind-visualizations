...
class Process
{
	...
	$list[36] = array(_("Log wind direction"),ProcessArg::VALUE,"log_wind_dir",2,DataType::REALTIME,"Wind",array(Engine::PHPFIWA));
    ...
    public function log_wind_dir($arg, $id, $time, $value)
    {
