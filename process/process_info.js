var process_info = {
    ...
    '36':"Convert degre in axis position (ex: N=0,E=90,S=180,W=270), the argument is the number of columns (8,16,32)",
    
    '37':"Convert the wind speed in in the good column",	
